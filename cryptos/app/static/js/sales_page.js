...
function App() {
  ...
  const newOrder = ()=>{
    setModalDescription("New Crypto");
    setItemId(null);
    setItem("");
    setPrice(0);
    setQuantity(0);
  ...
  const editOrder = (data)=>{
    setModalDescription("Edit Crypto");
    setItemId(data.id);
    setItem(data.item);
    setPrice(data.price);
  ...
  const saveOrder = (e)=>{
    ...
    if (item.length * price * quantity === 0)
      setError("Please enter crypto name, price and quantity");
    else {
      if (itemId === null)
    ...
    <div onKeyDown={keyDownHandler}>
        ...
        <div className="modal-dialog shadow">
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <label style={{marginTop: "1em"}}>Circulating Supply</label>
                <div className="form-group">
            ...
            <div className="modal-footer">
              ...
              <button type="submit" className="btn btn-primary" onClick={saveOrder}>Add Crypto</button>
            </div>
          </div>
          </form>
        </div>
      ...
      <div style={{maxWidth: "800px", margin: "auto", marginTop: "1em", marginBottom: "1em",
        ...
        <div style={{display: "flex", flexDirection: "row"}}>
          <span>Welcome, username here</span>
          <a className="btn btn-danger" style={{marginLeft: "auto"}} onClick={logout}>Logout</a>
        </div>
      </div>
      <div style={{maxWidth: "800px", margin: "auto", marginTop: "1em", marginBottom: "1em",
                    padding: "1em"}} className="shadow">
            ...
            <tr key={row.id}>
              ...
              <td>
                ...
                <a className="btn btn-danger" style={{marginLeft: "auto"}}
                  ...
                  <a className="btn btn-warning" style={{marginLeft: "5px", color: 'white'}}
                  onClick={(e)=>{favOrder(row.id)}}>Fav</a>
              </td>
            </tr>
          )}
          </tbody>
